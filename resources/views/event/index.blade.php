              ...
              <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex">
                      <h4><i class="fa fa-align-justify"></i>  {{ __('Activities Management') }}</h4>
                        ...
                        @foreach($event as $nw)
                            <tr>
                              ...
                              @if(auth()->user()->user_type == 2)
                                <td>
                                  <button class="btn btn-block btn-danger btn-request" data-url="{{ URL::to('/requestEvents',$nw->id) }}"><i class="cil-trash"></i></button>
                                </td>
                              @else
                              <td>
                              <form action="{{ route('events.destroy',$nw->id) }}" method="post" >
