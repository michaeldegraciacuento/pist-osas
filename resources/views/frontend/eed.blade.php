  ...
  <div class="container">
      ...
      <div class="col-12 col-lg-6 y-5">
        <div class=" h-100">
          <div class="col-8 col-lg-10 mx-auto">
           <p class="fs-bold fs-3">What is Economic and Enterprise Development?</p>
           <p class="fs-bold fs-5">
           Economic Enterprise Development refers to the process of creating, expanding, and strengthening businesses and organizations to stimulate economic growth and development in a particular area. This includes supporting entrepreneurship, small and medium-sized enterprises (SMEs), and other businesses that contribute to economic activity and job creation
           ​</p>
          </div>
      ...
      <div class="row h-100">
          <div class="col-8 col-lg-10 mx-auto d-flex align-items-center">
            <img class="img-fluid" src="metis-assets/illustrations/financial-report.png" alt="" >
          </div>
        </div>
      </div>
      </div>
