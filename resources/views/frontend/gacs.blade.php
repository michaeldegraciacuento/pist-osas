      ...
      <div class="row">
        <div class="col-12 col-lg-7 py-5 mx-auto text-center">
          <h2 class="mb-3 fs-1 fw-bold">
            <span>Guidance and</span>
            <span class="text-primary">Counseling</span>
            <span>Services</span>
  ...
  <div class="container">
      ...
      <div class="col-12 col-lg-6 y-5">
        <div class=" h-100">
          <div class="col-8 col-lg-10 mx-auto">
           <p class="fs-bold fs-3">What are the Guidance and Counseling Services?</p>
           <p class="fs-bold fs-5">The student can book an appointment with the Guidance Counselor. He/she can have private counseling on his/her concerns.</p>
          </div>
          <a href="{{url('/login')}}" class="btn btn-primary" style="float:right;">Book Now!</a>
        </div>
      ...
      <div class="row h-100">
          <div class="col-8 col-lg-10 mx-auto d-flex align-items-center">
            <img class="img-fluid" src="img/gacs.webp" alt="">
          </div>
        </div>
      </div>
      </div>
