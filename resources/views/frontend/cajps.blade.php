      ...
      <div class="row">
        <div class="col-12 col-lg-7 py-5 mx-auto text-center">
          <h2 class="mb-3 fs-1 fw-bold">
            <span>Career and</span>
            <span class="text-primary">Job Placement</span>
            <span>Services</span>
  ...
  <div class="container">
      ...
      <div class="col-12 col-lg-6 y-5">
        <div class=" h-100">
          <div class="col-8 col-lg-10 mx-auto">
           <p class="fs-bold fs-3">What is Career and Job Placement?</p>
           <p class="fs-bold fs-5">Career and job placement services are programs offered by educational institutions, government agencies, and private organizations to assist individuals in finding employment and advancing their careers. These services typically include a variety of resources, such as career counseling, job search assistance, resume writing, interview preparation, and networking opportunities.​</p>
          </div>
      ...
      <div class="row h-100">
          <div class="col-8 col-lg-10 mx-auto d-flex align-items-center">
            <img class="img-fluid" src="img/cag.jpeg" alt="" style="width:600px;">
          </div>
        </div>
      </div>
      </div>
