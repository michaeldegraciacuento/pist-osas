...
<section class="py-5 mb-5">
  ...
  <div class="col-12 px-3 col-lg-7 mx-auto">
        <div class="mb-4 text-center">
          <h2 class="mt-3 fs-1 fw-bold">Information and Orientation Services happened only in 1st semester of the the school year. </h2>
        </div>
        
        <p class="mb-4 text-muted lh-lg fw-bold">
        Information and Orientation Services During a student general assembly, students may elect representatives to student government, discuss proposed changes to school policies or procedures, propose new clubs or organizations, or vote on budgetary matters related to student activities. It is also a forum for students to voice their opinions, ask questions, and engage in open dialogue with school administrators or other stakeholders.
        </p>    
      </div>
      <div class="row">
      <div class="col-12 col-lg-6 y-5">
        <div class="row h-100">
          <div class="col-8 col-lg-10 mx-auto d-flex align-items-center">
            <img class="img-fluid" src="img/iaos2.jpeg" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row h-100">
          <div class="col-8 col-lg-10 mx-auto d-flex align-items-center">
            <img class="img-fluid" src="img/iaos1.jpeg" alt="">
          </div>
        </div>
      </div>
      </div>
